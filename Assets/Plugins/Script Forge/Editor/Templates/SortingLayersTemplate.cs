...
namespace ScriptForge
{
    ...
    public partial class SortingLayersTemplate : ScriptForge.BaseTemplate
    {
        /// <summary>
...
/// </summary>
        ...
        private string[] _m_SortingLayersField;

/// <summary>
/// Access the m_SortingLayers parameter of the template.
/// </summary>
        private string[] m_SortingLayers
        {
            get
            {
                return this._m_SortingLayersField;
            }
        }
...
/// </summary>
        public override void Initialize()
        {
            ...
            if( ( this.Errors.HasErrors == false ) )
            {
                ...
                bool m_SortingLayersValueAcquired = false;
                if( this.Session.ContainsKey( "m_SortingLayers" ) )
                {
                    this._m_SortingLayersField = ( ( string[] )( this.Session["m_SortingLayers"] ) );
                    m_SortingLayersValueAcquired = true;
                }
                if( ( m_SortingLayersValueAcquired == false ) )
                {
                    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData( "m_SortingLayers" );
                    if( ( data != null ) )
                    {
                        this._m_SortingLayersField = ( ( string[] )( data ) );
                    }
                }
